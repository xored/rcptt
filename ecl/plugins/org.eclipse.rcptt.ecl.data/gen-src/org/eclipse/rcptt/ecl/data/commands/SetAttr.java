 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.rcptt.ecl.data.commands.SetAttr#getTree <em>Tree</em>}</li>
 ...
 * @model annotation="http://www.eclipse.org/ecl/docs description='Sets value of the tree node attribute. If <code>value</code> parameter is not specified, the attribute will be removed.' returns='The value of <code>tree</code> argument' example='tree-node \"Device\" [map [entry \"id\" \"1\"] [entry \"name\" \"first\"]]\n\t| get-attr \"name\" | log\n\n\n--set-attr-\n\n\n\ntree-node \"Device\" [map [entry \"id\" \"1\"] [entry \"name\" \"first\"]]\n\t| set-attr \"name\" \"second\" | get-attr \"name\" | log'"
 * @generated
 */
public interface SetAttr extends Command {
	 ...
	 * @see #setTree(Tree)
	 * @see org.eclipse.rcptt.ecl.data.commands.CommandsPackage#getSetAttr_Tree()
	 * @model required="true"
	 *        annotation="http://www.eclipse.org/ecl/docs description='Tree node to set attribute to'"
	 * @generated
	 */
	Tree getTree();

	/**
	 * Sets the value of the '{@link org.eclipse.rcptt.ecl.data.commands.SetAttr#getTree <em>Tree</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @model annotation="http://www.eclipse.org/ecl/docs description='New value of the node attribute'"
	 * @generated
	 */
	String getValue();
