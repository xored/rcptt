...
"""
  ...
  void archive() {
    ...
    this.script.archiveArtifacts allowEmptyArchive: true, artifacts: "repository/rap/target/repository/**/* $FULL_REPOSITORY_DIR/**/*, $PRODUCTS_DIR/*, $RUNNER_DIR/*.zip, maven-plugin/rcptt-maven-*/target/rcptt-maven-*.jar, $DOC_DIR/target/doc/**/*, **/target/**/*.log"
  }
