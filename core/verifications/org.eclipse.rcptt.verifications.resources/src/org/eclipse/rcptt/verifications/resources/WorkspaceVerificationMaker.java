...
import org.eclipse.rcptt.verifications.internal.resources.Activator;
...
public class WorkspaceVerificationMaker extends DefaultVerificationMaker {
	...
	public void makeExecutable(Verification verification, IQ7NamedElement source)
		...
		makeSelfSufficientVerification((WorkspaceVerification) verification,
				source.getModifiedPersistenceModel(), source);
	}

	public void makeExecutableVerification(WSFile child, IFile iFile) {
		try {
	...
	public void makeSelfSufficientVerification(WorkspaceVerification verification,
		...
		WSRoot root = verification.getContent();
		if (root != null) {
